...
-- Dumping data for table webbook.book: ~1 rows (approximately)
DELETE FROM `book`;
...
INSERT INTO `bookmark` (`_id`, `USER_ID`, `EPISODE_ID`, `IS_DELETE`, `CREATE_DATE`, `UPDATE_DATE`, `EPISODE_NAME`, `NICKNAME`) VALUES
	(32, 10, 35, 0, '2015-12-30 16:53:21', '2015-12-30 16:53:21', NULL, NULL),
	(34, 10, 33, 0, '2015-12-30 16:50:17', '2015-12-30 16:50:17', NULL, NULL),
...
-- Dumping data for table webbook.book_viewing: ~11 rows (approximately)
...
-- Dumping data for table webbook.comment: ~37 rows (approximately)
DELETE FROM `comment`;
...
-- Dumping data for table webbook.episode: ~21 rows (approximately)
DELETE FROM `episode`;
...
INSERT INTO `user` (`_id`, `USERNAME`, `PASSWORD`, `NICKNAME`, `FULLNAME`, `AGE_GROUP_ID`, `AGE_GROUP_NAME`, `AUTHOR_LEVEL`, `AUTHOR_NAME`, `GENDER`, `DAY_OF_BIRTH`, `PHONE`, `EMAIL`, `ADULT_VERIFICATION`, `TOTAL_COUPON`, `LEAVE_REASON`, `ACTIVE`, `ROLE`, `IS_DELETE`, `CREATE_DATE`, `UPDATE_DATE`) VALUES
	(10, 'kenny', '698d51a19d8a121ce581499d7b701668', 'Bac Kieu Phong', 'Kenny Phong', 2, '유니티', 27, '베스트리그', '여', '1993-03-03', '09734252952', 'kennyphong2811@gmail.com', 0, 94, '', 1, 0, 0, '2016-01-08 18:30:18', '2016-01-20 13:48:01'),
