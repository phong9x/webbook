...
-- Server OS:                    Win32
>>>>>>> dfe59c630e7472e4735676da9d2d60e2058344c1
...
<<<<<<< HEAD
DROP TABLE IF EXISTS `interested_book`;
=======
>>>>>>> dfe59c630e7472e4735676da9d2d60e2058344c1
...
CREATE TABLE IF NOT EXISTS `post` (
  `_id` int(11) NOT NULL AUTO_INCREMENT,
  `USER_ID` int(11) DEFAULT NULL,
  `USER_NICKNAME` int(11) DEFAULT NULL,
=======
CREATE TABLE IF NOT EXISTS `post` (
  `_id` int(11) NOT NULL AUTO_INCREMENT,
  `USER_ID` int(11) DEFAULT NULL,
...
<<<<<<< HEAD
INSERT INTO `post` (`_id`, `USER_ID`, `USER_NICKNAME`, `TITLE`, `BULLETIN_ID`, `BULLETIN_NAME`, `IMAGE1`, `IMAGE2`, `CONTENTS`, `FILE1`, `FILE2`, `REPORT_NUMBER`, `VIEWS_NUMBER`, `IS_DELETE`, `UPDATE_DATE`, `CREATE_DATE`) VALUES
	(1, 10, NULL, 'oke men', 12, 'FAQ', NULL, NULL, 'good good good good good', NULL, NULL, 0, 0, 0, '2016-01-06 15:51:07', '2016-01-06 15:51:09'),
	(2, 10, NULL, 'oke men', 12, 'FAQ', NULL, NULL, 'good good good good good', NULL, NULL, 0, 0, 0, '2016-01-06 15:51:07', '2016-01-06 15:51:09'),
	(3, 10, NULL, 'oke men', 12, 'FAQ', NULL, NULL, 'good good good good good', NULL, NULL, 0, 0, 0, '2016-01-06 15:51:07', '2016-01-06 15:51:09'),
	...
	(18, 10, NULL, 'oke men', 12, 'FAQ', NULL, NULL, 'good good good good good', NULL, NULL, 0, 0, 0, '2016-01-06 15:51:07', '2016-01-06 15:51:09');
=======
...
<<<<<<< HEAD
DROP TABLE IF EXISTS `profit_refund`;
=======
>>>>>>> dfe59c630e7472e4735676da9d2d60e2058344c1
...
=======
	(10, 'kenny', '698d51a19d8a121ce581499d7b701668', 'Kenny222', 'kenny22', 1, '제너맨', 28, '챌린지리그', '여', '2015-05-05', '11111', 'kennyphong2811@gmail.com', NULL, 0, NULL, 1, 0, 0, '2016-01-08 18:30:18', '2016-01-11 10:22:21'),
>>>>>>> dfe59c630e7472e4735676da9d2d60e2058344c1
...
<<<<<<< HEAD
-- Dumping data for table webbook.visitor: ~0 rows (approximately)
=======
