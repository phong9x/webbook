...
-- Dumping data for table webbook.category: ~44 rows (approximately)
...
INSERT INTO `coupon_purchase` (`_id`, `USER_ID`, `CHARGE_AMOUNT`, `TOTAL_FEE`, `PAYMENT_METHOD_ID`, `PAYMENT_METHOD_NAME`, `CANCEL_REASON`, `CANCEL_CODE`, `CANCEL`, `IS_DELETE`, `CREATE_DATE`, `UPDATE_DATE`) VALUES
	...
	(3, 10, 100, 1000, 39, '무통장 입금', NULL, NULL, NULL, 0, '2016-01-08 11:24:29', '2016-01-08 11:24:30'),
	(4, 10, 110, 100000, 35, '휴대폰 결제', NULL, NULL, NULL, 0, '2016-01-08 14:10:46', '2016-01-08 14:10:46'),
	(5, 10, 55, 50000, 35, '휴대폰 결제', NULL, NULL, NULL, 0, '2016-01-08 14:17:40', '2016-01-08 14:17:40');
...
-- Dumping data for table webbook.coupon_used: ~6 rows (approximately)
...
INSERT INTO `coupon_used` (`_id`, `USER_ID`, `EPISODE_ID`, `BOOK_ID`, `CHARGE_AMOUNT`, `METHOD_PAYMENT`, `IS_DELETE`, `CREATE_DATE`, `UPDATE_DATE`) VALUES
	(1, 10, 47, 33, 1, NULL, 0, '2016-01-11 11:33:23', '2016-01-08 11:33:23'),
	...
	(14, 10, 47, 33, 1, NULL, 0, '2016-01-11 11:33:23', '2016-01-08 11:33:23'),
	(15, 10, 47, 33, 1, NULL, 0, '2016-01-11 11:33:23', '2016-01-08 11:33:23');
...
CREATE TABLE IF NOT EXISTS `report` (
  ...
  KEY `FK_report_comment` (`PARENT_ID`),
  CONSTRAINT `FK_report_user` FOREIGN KEY (`USER_ID`) REFERENCES `user` (`_id`)
) ENGINE=InnoDB AUTO_INCREMENT=21 DEFAULT CHARSET=utf8;

-- Dumping data for table webbook.report: ~19 rows (approximately)
DELETE FROM `report`;
/*!40000 ALTER TABLE `report` DISABLE KEYS */;
INSERT INTO `report` (`_id`, `USER_ID`, `PARENT_ID`, `REASON`, `IS_DELETE`, `CREATE_DATE`, `UPDATE_DATE`, `TYPE_KEY`) VALUES
	(2, 10, 1, '0', 0, '2016-01-11 17:01:28', '2016-01-11 17:01:30', 'COMMENT'),
	(3, 10, 1, '0', 0, '2016-01-11 17:01:31', '2016-01-11 17:01:32', 'POST'),
	(4, 10, 1, '0', 0, '2016-01-11 17:01:31', '2016-01-11 17:01:32', 'POST'),
	(5, 10, 1, '0', 0, '2016-01-11 17:01:31', '2016-01-11 17:01:32', 'POST'),
	(6, 10, 1, '0', 0, '2016-01-11 17:01:28', '2016-01-11 17:01:30', 'COMMENT'),
	(7, 10, 1, '0', 0, '2016-01-11 17:01:28', '2016-01-11 17:01:30', 'COMMENT'),
	(8, 10, 1, '0', 0, '2016-01-11 17:01:28', '2016-01-11 17:01:30', 'COMMENT'),
	(9, 10, 1, '0', 0, '2016-01-11 17:01:28', '2016-01-11 17:01:30', 'COMMENT'),
	(10, 10, 1, '0', 0, '2016-01-11 17:01:31', '2016-01-11 17:01:32', 'POST'),
	(11, 10, 1, '0', 0, '2016-01-11 17:01:31', '2016-01-11 17:01:32', 'POST'),
	(12, 10, 1, '0', 0, '2016-01-11 17:01:31', '2016-01-11 17:01:32', 'POST'),
	(13, 10, 1, '0', 0, '2016-01-11 17:01:31', '2016-01-11 17:01:32', 'POST'),
	(14, 10, 1, '0', 0, '2016-01-11 17:01:31', '2016-01-11 17:01:32', 'POST'),
	(15, 10, 1, '0', 0, '2016-01-11 17:01:31', '2016-01-11 17:01:32', 'POST'),
	(16, 10, 1, '0', 0, '2016-01-11 17:01:31', '2016-01-11 17:01:32', 'POST'),
	(17, 10, 1, '0', 0, '2016-01-11 17:01:31', '2016-01-11 17:01:32', 'POST'),
	(18, 10, 1, '0', 0, '2016-01-11 17:01:31', '2016-01-11 17:01:32', 'POST'),
	(19, 10, 1, '0', 0, '2016-01-11 17:01:31', '2016-01-11 17:01:32', 'POST'),
	(20, 10, 1, '0', 0, '2016-01-11 17:01:28', '2016-01-11 17:01:30', 'COMMENT');
