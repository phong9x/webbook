$(document).ready(function() {
  ...
  // /* --------------------------------------------------------------------- */
  // (function($) {
  //   if (!$(".wb-inputbox[type='password']").length) return;

  //   $(".wb-inputbox-wrapper").each(function() {
  //     var inputboxPass = $(this).find(".wb-inputbox[type='password']");

  //     inputboxPass.after('<i class="wb-inputbox-icon wb-icon-show-password fa fa-eye"></i>');
  //     var iconShowPassword = $(this).find(".wb-icon-show-password");
