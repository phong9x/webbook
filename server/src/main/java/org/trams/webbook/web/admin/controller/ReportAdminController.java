...
public class ReportAdminController extends AbstractController {
	...
	private static final String JSP_CREATE   = "admin/report/create";
	private static final String JSP_LIST   = "admin/report/list";
	private static final String JSP_PAGING   = "admin/report";
	private static final String JSP_EDIT   = "admin/report/edit";
	private static final String JSP_DETAIL   = "admin/report/detail";
	...
	public ReportAdminController() {
		super(ReportAdminController.class, MAIN_ENTITY_NAME );
		log("ReportAdminController created.");
	}
	//Decription: List all report
	//Url: http://kwebsosul.com//admin/report/list
	@RequestMapping("/list")
	public String list(
