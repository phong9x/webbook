 ...
 */
@Controller
@RequestMapping("/admin/interestedBook")
public class InterestedBookAdminController extends AbstractController {
	...
	private static final String JSP_CREATE   = "admin/interestedBook/create";
	private static final String JSP_LIST   = "admin/interestedBook/list";
	private static final String JSP_PAGING   = "admin/interestedBook";
	private static final String JSP_EDIT   = "admin/interestedBook/edit";
	private static final String JSP_DETAIL   = "admin/interestedBook/detail";
	 ...
	 * Default constructor
	 */
	public InterestedBookAdminController() {
		super(InterestedBookAdminController.class, MAIN_ENTITY_NAME );
		log("InterestedBookAdminController created.");
	}
